...
describe('EmpleadoController', () => {
    ...
    describe('obtenerTodos()', () => {
        it('Debería llamar a ListarEmpleadosUseCase y retornar la paginación', async () => {
            ...
            mockListarEmpleadosUC.execute.mockResolvedValue({ data: [], meta: { total: 0 } });
    ...
    describe('deletedEmpleado()', () => {
        it('Debería llamar a EliminarEmpleadoUseCase y retornar el estado', async () => {
            const id = 'uuid-123';
            mockEliminarEmpleadoUC.execute.mockResolvedValue({ activo: false, fecha_cese: new Date() });
    ...
    describe('reactive()', () => {
        it('Debería llamar a ActiveEmpleadoUseCase y retornar el estado', async () => {
            const id = 'uuid-123';
            mockActiveEmpleadoUC.execute.mockResolvedValue({ state: true, message: 'Reactivado' });
