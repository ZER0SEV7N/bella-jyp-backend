...
-- 2. Catálogos Base
INSERT INTO
    estado_empleado (id, descripcion)
VALUES (
        '018f4a7c-1111-7000-a000-000000000001',
        'ACTIVO'
    ),
    (
        '018f4a7c-1111-7000-a000-000000000002',
        'SUSPENDIDO'
    ),
    (
        '018f4a7c-1111-7000-a000-000000000003',
        'CESADO'
    );
...
VALUES (
    ...
    (
        '018f4a7c-2222-7000-b000-000000000003',
        'PASAPORTE'
    );
...
INSERT INTO
    bancos (id, nombre)
VALUES (
        '018f4a7c-3333-7000-c000-000000000001',
        'Banco de Crédito del Perú (BCP)'
    ),
    (
        '018f4a7c-3333-7000-c000-000000000002',
        'BBVA Continental'
    ),
    (
        '018f4a7c-3333-7000-c000-000000000003',
        'Interbank'
    ),
    (
        '018f4a7c-3333-7000-c000-000000000004',
        'Scotiabank Perú'
    );

INSERT INTO
    regimen_pension (id, nombre)
VALUES (
        '018f4a7c-4444-7000-d000-000000000001',
        'ONP (Sistema Nacional)'
    ),
    (
        '018f4a7c-4444-7000-d000-000000000002',
        'SPP (Sistema Privado - AFP)'
    );

INSERT INTO
    tipo_afp (id, id_regimen, nombre)
VALUES (
        '018f4a7c-5555-7000-e000-000000000001',
        '018f4a7c-4444-7000-d000-000000000002',
        'AFP INTEGRA'
    ),
    (
        '018f4a7c-5555-7000-e000-000000000002',
        '018f4a7c-4444-7000-d000-000000000002',
        'AFP PRIMA'
    ),
    (
        '018f4a7c-5555-7000-e000-000000000003',
        '018f4a7c-4444-7000-d000-000000000002',
        'AFP HABITAT'
    ),
    (
        '018f4a7c-5555-7000-e000-000000000004',
        '018f4a7c-4444-7000-d000-000000000002',
        'AFP PROFUTURO'
    );
...
VALUES (
        ...
        'TIEMPO_COMPLETO',
        'MANANA', -- o 'MADRUGADA' según tengas en tu enum
        'PRESENCIAL',
        15,
        40.00,
        '[
...
-- 5. Jornada <-> Áreas
INSERT INTO
    jornada_area (jornada_id, area_id)
VALUES (
        '018f4a7c-6666-7000-f000-000000000001',
        '018f4a7c-7777-7000-1111-000000000001'
    ),
...
VALUES (
        ...
        'Gestión integral del sistema TI',
        3500.00,
        6000.00,
        true
    ),
    (
        ...
        '018f4a7c-7777-7000-1111-000000000002',
        'Contador Principal',
        'Encargado de Planillas y Cierres',
        3000.00,
        5000.00,
        true
    ),
...
-- 8. Usuarios del Sistema (Contraseña para todos: Admin123!)
-- Hash Argon2id para 'Admin123!': $argon2id$v=19$m=65536,t=3,p=4$qN7jWlR59W/4f9j4N6tK6Q$vLhK0K9xG8wT5rR2sZ1uB8cM9eF2aP4oQ7yW8xV3zU0
INSERT INTO
    usuarios (
        id,
        empleado_id,
...
VALUES (
        '018f4a7c-aaaa-7000-4444-000000000001',
        '018f4a7c-9999-7000-3333-000000000001',
        'admin@jyp.com',
        '$argon2id$v=19$m=65536,t=3,p=4$qN7jWlR59W/4f9j4N6tK6Q$vLhK0K9xG8wT5rR2sZ1uB8cM9eF2aP4oQ7yW8xV3zU0',
        'ADMIN',
        true,
        NOW(),
        NOW()
    ...
    (
        '018f4a7c-aaaa-7000-4444-000000000002',
        '018f4a7c-9999-7000-3333-000000000002',
        'contador@jyp.com',
        '$argon2id$v=19$m=65536,t=3,p=4$qN7jWlR59W/4f9j4N6tK6Q$vLhK0K9xG8wT5rR2sZ1uB8cM9eF2aP4oQ7yW8xV3zU0',
        'CONTADOR',
    ...
    (
        '018f4a7c-aaaa-7000-4444-000000000003',
        '018f4a7c-9999-7000-3333-000000000003',
        'rrhh@jyp.com',
        '$argon2id$v=19$m=65536,t=3,p=4$qN7jWlR59W/4f9j4N6tK6Q$vLhK0K9xG8wT5rR2sZ1uB8cM9eF2aP4oQ7yW8xV3zU0',
        'RRHH',
...
-- 9. Datos Financieros Iniciales (Ejemplo para Carlos Ramírez - Contador)
