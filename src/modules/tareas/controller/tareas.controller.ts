...
export class TareasController {
    ...
    async cambiarEstado(
        ...
        return await this.flujoTareasUseCase.cambiarEstado(id, payload, req.user.id, req.user.rol);
    }
    ...
    async agregarAnotacion(
        ...
        return await this.flujoTareasUseCase.agregarAnotacion(id, payload, req.user.id);
    }
}
