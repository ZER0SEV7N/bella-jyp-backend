//src/modules/auth/use-cases/RefrescarToken.useCase.ts
...
export class RefrescarTokenUseCase {
    ...
    async execute(refreshToken: string) {
        ...
        try{
            ...
            if(!user || !user.activo || user.deleted_at !== null ) throw new UnauthorizedException('Usuario no encontrado o inactivo.');
