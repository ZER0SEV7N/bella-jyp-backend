...
import { Controller, Post, Req, Res, UseGuards, BadRequestException, HttpStatus, Get, Param } from '@nestjs/common';
...
export class EmpleadoBulkController {
    ...
    async uploadBulk(
        ...
        this.procesarCargaMasiva.execute(jobId, usuarioId, data.file)
            .catch((error) => {
