//src/modules/RRHH/organizacion/use-cases/area/eliminarArea.useCase.ts
    ...
    try {
      ...
      if (!area || area.deleted_at !== null)
        throw new NotFoundException(
          `El área con ID ${areaId} no existe o ya fue eliminada`,
        );
      ...
      if (cargosActivos > 0)
        throw new BadRequestException(
          'No se puede eliminar el área porque contiene cargos activos asignados. Reasigne o desactive los cargos primero.',
        );
      ...
      throw new InternalServerErrorException(
        'Error al intentar eliminar (Soft Delete) el área',
      );
    }
  }
}
