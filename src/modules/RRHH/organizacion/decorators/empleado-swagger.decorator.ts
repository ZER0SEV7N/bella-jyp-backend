...
export function ApiSwaggerActualizarEmpleado() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Actualiza los detalles de un empleado existente. Requiere rol ADMIN o RRHH.',
    }),
    ApiParam({
      name: 'id',
    ...
    ApiResponse({
      status: 404,
      description:
        'No encontrado. El empleado con el ID proporcionado no existe.',
    }),
  );
}
/**
