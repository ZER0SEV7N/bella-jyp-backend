...
export function ApiSwaggerCrearCargo() {
    return applyDecorators(
        ApiOperation({
            summary: 'Crear Cargo',
            description: 'Registra un nuevo cargo o puesto de trabajo en el sistema. Requiere rol ADMIN o RRHH.',
        }),
        ApiBody({
            schema: {
                type: 'object',
                ...
                properties: {
                    id_area: { type: 'string', format: 'uuid', example: '123e4567-e89b-12d3-a456-426614174000' },
                    nombre: { type: 'string', example: 'Gerente de Ventas' },
                    descripcion: { type: 'string', example: 'Responsable de liderar el equipo de ventas y alcanzar los objetivos comerciales.' },
                },
            },
        }),
        ApiResponse({
...
export function ApiSwaggerActualizarCargo() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Actualiza los detalles de un cargo existente en el sistema. Requiere rol ADMIN o RRHH.',
        }),
        ApiParam({
            name: 'id',
...
export function ApiSwaggerDesactivarCargo() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Desactiva un cargo existente en el sistema. Requiere rol ADMIN o RRHH.',
        }),
        ApiParam({
            name: 'id',
...
export function ApiSwaggerReactivarCargo() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Reactiva un cargo previamente desactivado en el sistema. Requiere rol ADMIN o RRHH.',
        }),
        ApiParam({
            name: 'id',
