...
export const EnvSchema = z.object({
    ...
    JWT_ACCESS_SECRET: z.string().min(32, 'La clave secreta debe tener al menos 32 caracteres'),
    JWT_REFRESH_SECRET: z.string().min(32, 'La clave secreta debe tener al menos 32 caracteres'),
});
